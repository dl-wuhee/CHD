module config
  ...
  use fio
  implicit none
  public con_dx,  con_dt, con_imethod, con_result_filename, &
    con_log_filename

  public read_from_config

  real(kind=dp) :: con_dx, con_dt
  integer(kind=di) :: con_imethod
  character(len=255) :: &
    config_filename, &
    con_result_filename, &
    con_log_filename
  namelist /conf/ con_imethod, con_dx, con_dt, con_result_filename, con_log_filename
contains
